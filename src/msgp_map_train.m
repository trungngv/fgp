function [w,fval,zmap] = msgp_map_train(w,x,y,K,nu,max_iters,hyp_iters)
%MSGP_MAP_TRAIN [w,fval,zmap] = msgp_map_train(w,x,y,K,nu,max_iters,hyp_iters)
% 
% Training for mixture of sparse gaussian process.
% This version uses the true zmap for assignments.
%
% 29/05/13
% Trung V. Nguyen
%
...
zmap = zmap_mahala(W(1:end-dim-2,:),x,nu); % init
